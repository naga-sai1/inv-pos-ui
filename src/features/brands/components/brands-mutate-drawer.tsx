        ...
        toast({
          ...
          description: (
            <pre className='mt-2 w-[340px] rounded-md bg-slate-950 p-4'>
              <code className='text-white '>Manufacturer created successfully.</code>
            </pre>
          ),
          variant: 'success',
        })
    ...
    >
      <SheetContent className='flex flex-col'>
        <SheetHeader className='text-left'>
          <SheetTitle>{isUpdate ? 'Update' : 'Create'} Manufacturer</SheetTitle>
          <SheetDescription>
            {isUpdate
              ? 'Update the manufacturer by providing necessary info.'
              : 'Add a new manufacturer by providing necessary info.'}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='space-y-1'>
                  ...
                  <FormControl>
                    <Input {...field} placeholder='Enter a manufacturer' />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
                  <div className='space-y-0.5'>
                    ...
                    <FormDescription>
                    Manufacturer will be {field.value ? 'active' : 'inactive'}
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
